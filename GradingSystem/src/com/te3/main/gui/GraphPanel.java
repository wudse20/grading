...
public class GraphPanel extends JPanel {
	...
	public void paintComponent(Graphics gOld) {
		...
		if (f != 0) {
			// Draws the line
			g.drawLine(MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN, MARGIN_TOP + HEIGHT - diff,
					MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN, MARGIN_TOP + HEIGHT - fHeight + diff);
		}
		...
		if (e != 0) {
			// Draws the line
			g.drawLine((MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 2, MARGIN_TOP + HEIGHT - diff,
					(MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 2, MARGIN_TOP + HEIGHT - eHeight + diff);
		}
		...
		if (c != 0) {
			// Draws the line
			g.drawLine((MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 3, MARGIN_TOP + HEIGHT - diff,
					(MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 3, MARGIN_TOP + HEIGHT - cHeight + diff);
		}
		...
		if (a != 0) {
			// Draws the line
			g.drawLine((MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 4, MARGIN_TOP + HEIGHT - diff,
					(MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 4, MARGIN_TOP + HEIGHT - aHeight + diff);
		}
		...
		// Draws letter E
		g.drawString("E", (MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 2 - letterDiffX,
				MARGIN_TOP + HEIGHT + letterDiffY);

		// Draws letter C
		g.drawString("C", (MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 3 - letterDiffX,
				MARGIN_TOP + HEIGHT + letterDiffY);

		// Draws letter A
		g.drawString("A", (MARGIN_LEFT + GRAPH_AXIS_PILLAR_MARGIN) * 4 - letterDiffX,
				MARGIN_TOP + HEIGHT + letterDiffY);

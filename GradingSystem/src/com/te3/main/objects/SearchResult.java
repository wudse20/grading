...
public class SearchResult {
	 ...
	 * @return if name is equal to the name of the students of this result true,
	 *         else false. Are there no students it will return false.
	 */
	...
	public String toString() {
		/*
		 * If there are students in the list it will return the name of the first
		 * student in the list. Which will be the name of all the students, else if will

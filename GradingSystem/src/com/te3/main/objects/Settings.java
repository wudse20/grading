...
public class Settings {
	...
	public void setSavePath(String savePath) throws IllegalInputException {
	     ...
	     *
	     * if true then it will throw an exception
	     * else it will set the path
	     * */
     ...
     * @throws IllegalInputException if the time isn't in the interval: 60 < timer < 3600
     */
     ...
     *
     * @return {@code true} if baby yoda should be shown else it will return {@code false}
     */

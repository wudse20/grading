...
public class Student {
	 ...
	 * @throws IllegalNameException if the trimmed name is too short (> 3
	 *                              characters)
	 */
	public void setName(String name) throws IllegalNameException {
		/*
		 * Checks if the name is ok, if it is then it will set the new name else if will
	 ...
	 *
	 * @param courses the list of courses, if {@code null} then it will set an empty
	 *                list
	 */
